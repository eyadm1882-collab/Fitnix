  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-black text-gray-900">مراقبة AI</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {[
          ...
          <motion.div key={card.label} className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm" whileHover={{ y: -2 }}>
